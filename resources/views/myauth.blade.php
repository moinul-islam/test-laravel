                    ...
                    <form id="emailForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                title="Enter a valid email address or a valid 11-digit phone number"
                                required
                                autocomplete="off"
                            >
...
$(document).ready(function() {
    ...
    // Custom email or phone number validation function
    ...
    $('#emailForm').on('submit', function(e) {
        ...
        if (!isValidEmailOrPhone(email)) {
            ...
            showError('auth_email', 'Please enter a valid email address or an 11-digit phone number.');
            return;
        }
