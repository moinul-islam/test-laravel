...
class PostController extends Controller
{
   ...
   public function index(Request $request)
   {
    ...
    public function store(Request $request)
    {
        ...
        // Custom validation: Category is required, and at least one of (description OR media_data)
        $request->validate([
        ...
        $postData = [
            'title' => $request->filled('title') ? $request->title : 'Post by ' . Auth::user()->name, // Auto-generate title if not provided
            'user_id' => $user_id,
